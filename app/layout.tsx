...
export const metadata: Metadata = {
  title: "Open Box Ventures LLP — Media, Content & Strategy",
  description:
    "Open Box Ventures LLP delivers experiential media production, brand content, and public strategy and consulting — end to end.",
};
