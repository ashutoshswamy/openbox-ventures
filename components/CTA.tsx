...
export function CTA({
  ...
  return (
    <section className="overflow-hidden border-t border-line px-6 py-20 md:px-10 md:py-28">
      <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-2">
        <div>
          <ScrollHeadline className="max-w-3xl font-display text-display-lg leading-tight">
            {headline}
          </ScrollHeadline>
        ...
        <ScrollReveal delay={0.1}>
          <Image
            src="/oneteam.png"
            alt="Our service lines connected around one team"
            width={1699}
            height={926}
            className="h-auto w-full lg:-ml-24 lg:w-[125%] lg:max-w-none"
          />
        </ScrollReveal>
      </div>
    </section>
